...
class compare_data(object):
    ...
    def __init__(self, url="https://covid-tracker-us.herokuapp.com", data_source='jhu'):
        ...
        if url == self.default_url:
            ...
            for mirror in self.mirrors:
                ...
                result = None
                try:
                    compare = compare_data(self,url,data_source)
                    result = compare._getSources()
    ...
    def getLatest(self) -> List[Dict[str, int]]:
        ...
        """
        compare = compare_data(self,url,data_source)
        data = compare._request("/v2/latest")
        return data["latest"]
    ...
    def getLocations(self, timelines=False, rank_by: str = None) -> List[Dict]:
        ...
        if timelines:
            compare = compare_data(self,url,data_source)
            data = compare._request("/v2/locations", {"timelines": str(timelines).lower()})
            
        else:
            compare = compare_data(self,url,data_source)
            data = compare._request("/v2/locations")
    ...
    def getLocationByCountryCode(self, country_code, timelines=False) -> List[Dict]:
        ...
        if timelines:
            compare = compare_data(self,url,data_source)
            data = compare._request("/v2/locations", {"country_code": country_code, "timelines": str(timelines).lower()})

        else:
            compare = compare_data(self,url,data_source)
            data = compare._request("/v2/locations", {"country_code": country_code})
    ...
    def getLocationByCountry(self, country, timelines=False) -> List[Dict]:
        ...
        if timelines:
            compare = compare_data(self,url,data_source)
            data = compare._request("/v2/locations", {"country": country, "timelines": str(timelines).lower()})
        else:
            compare = compare_data(self,url,data_source)
            data = compare._request("/v2/locations", {"country": country})
        return data["locations"]
    ...
    def getLocationById(self, country_id: int):
        ...
        """
        compare = compare_data(self,url,data_source)
        data = compare._request("/v2/locations/" + str(country_id))
