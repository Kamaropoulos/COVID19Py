...
class locationBasedInfo:
    @abstractmethod
    def getLocations(self, timelines=False, rank_by: str = None) -> List[Dict]:
        pass
class countryBasedInfo:
    @abstractmethod
...
class getInfoByLocation(locationBasedInfo):
...
class getInfoByCountry(countryBasedInfo):
    def getLocationByCountryCode(self, country_code, timelines=False) -> List[Dict]:
        """
