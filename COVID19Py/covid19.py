...
class COVID19_singleton_pattern(object):
   __instance = None
   ...
   def __init__(self, url="https://covid-tracker-us.herokuapp.com", data_source='jhu'):
       ...
       if COVID19_singleton_pattern.__instance != None:
   ...
   def getInstance():
     if COVID19_singleton_pattern.__instance == None:
       COVID19_singleton_pattern()
     return COVID19_singleton_pattern.__instance
