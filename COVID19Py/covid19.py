...
class COVID19:
    ...
    def getLocations(self, timelines=False, rank_by: str = None) -> List[Dict]:
        ...
        timelines = timelines 
        return self.apiData.getLocations(timelines=timelines)
    ...
    def getLocationByCountryCode(self, country_code, timelines=False) -> List[Dict]:
        ...
        return self.apiData.getLocationByCountryCode(country_code=country_code)
    ...
    def getLocationByCountry(self, country, timelines=False) -> List[Dict]:
        ...
        country = country
        timelines = timelines
        return self.apiData.getLocationByCountry(country=country, timelines=timelines)
