...
class extract_country(country_retreve_info):
   def getLocationByCountryCode(self, country_code, timelines=False) -> List[Dict]:
       data = None
       if timelines:
...
class location_retreve_info:
 
   @abstractmethod
   def getLocations(self, timelines=False, rank_by: str = None) -> List[Dict]:
       pass
 
class extract_location(location_retreve_info):
...
class extract(update_or_retreve_info_):
